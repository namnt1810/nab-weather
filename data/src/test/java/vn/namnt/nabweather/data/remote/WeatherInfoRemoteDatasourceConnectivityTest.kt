...
class WeatherInfoRemoteDatasourceConnectivityTest {
    ...
    @Test(expected = vn.namnt.nabweather.data.NoConnectivityException::class)
    fun noConnectivityTest() = runTest {
        ...
        datasource.getWeatherInfo("any", 1, vn.namnt.nabweather.common.TemperatureUnit.DEFAULT)
    }
