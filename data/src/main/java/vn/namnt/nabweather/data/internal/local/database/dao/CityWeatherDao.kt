package vn.namnt.nabweather.data.internal.local.database.dao
...
import vn.namnt.nabweather.data.internal.local.database.entity.WeatherDatabaseTableName
 ...
 */
@Dao
internal interface CityWeatherDao {
